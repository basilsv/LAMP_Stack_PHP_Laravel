                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="zip_code" v-model="ssip_code" class="form-control" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button type="submit" class="btn btn-warning" v-on:click.prevent="getUserAddress()">Place Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="summary-block" v-for="summaryItem in items" :key="summaryItem.id">
                            <div class="summary-content" v-if="summaryItem.name">
                                ...
                                <div class="summary-price">
                                    ...
                                    <span class="summary-small-text pull-right">Q {{summaryItem.quantity}} x P {{summaryItem.sale_price}}</span>
                                </div>
                            </div>
                        </div>
...
<script>
    export default {
        ...
        methods:{
           ...
           async getUserAddress(){
                ...
                console.log(response.data);
                    ...
                    this.$toastr.e('<p style="background-color:red;">User Info incomplete</p>');
                }
        ...
        mounted() {
           console.log("Get Cart Items mounted succesfully");
        }
    }
</script>
